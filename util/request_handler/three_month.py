...
def extract_third_month(data_json) -> ThirdMonthPredict:
    """
    ...
    online_bottle_one = convert_to_int(data["`电商预估轻饮酒总销量（瓶）`"])
    online_box_one = convert_to_int(data["`电商预估蓝气罐总销量（箱）`"])
    ...
    online_bottle_two = convert_to_int(data["`电商预估轻饮酒总销量（瓶）-二月`"])
    online_box_two = convert_to_int(data["`电商预估蓝气罐总销量（箱）-二月`"])
    ...
    online_bottle_three = convert_to_int(data["`电商预估轻饮酒总销量（瓶）-三月`"])
    online_box_three = convert_to_int(data["`电商预估蓝气罐总销量（箱）-三月`"])
    ...
    return ThirdMonthPredict(predict_id, predict_man, predict_start_time, predict_end_time, predict_part,
                             total_money_one,
                             increase_shops_one, bottle_sale_one, box_sale_one, online_bottle_one, online_box_one,
                             total_money_two, increase_shops_two,
                             bottle_sale_two, box_sale_two, online_bottle_two, online_box_two, total_money_three,
                             increase_shops_three, bottle_sale_three,
                             box_sale_three, online_bottle_three, online_box_three, predict_sale, area_one,
                             province_one, region_one, area_two, province_two,
...
def verified_third_month(data_json) -> ThirdMonthPredict:
    ...
    if verify_auth_token(data_json):
        return extract_third_month(data_json)
