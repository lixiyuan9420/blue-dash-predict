...
insertion_three_month = "insert into 三月销量预测(预算制定流水号,预算填写人,预算期间," \
                        ...
                        "`线下渠道预估蓝气罐总销量（箱）`,`电商预估轻饮酒总销量（瓶）`,`电商预估蓝气罐总销量（箱）`,`预测销售总金额-二月`," \
                        "`预计新增门店数-二月`,`线下渠道预估轻饮酒总销量（瓶）-二月`," \
                        "`线下渠道预估蓝气罐总销量（箱）-二月`,`电商预估轻饮酒总销量（瓶）-二月`,`电商预估蓝气罐总销量（箱）-二月`," \
                        "`预测销售总金额-三月`,`预计新增门店数-三月`,`线下渠道预估轻饮酒总销量（瓶）-三月`," \
                        "`线下渠道预估蓝气罐总销量（箱）-三月`,`电商预估轻饮酒总销量（瓶）-三月`,`电商预估蓝气罐总销量（箱）-三月`," \
                        "销售预测,`大区-第一月线下`,`省份-第一月线下`,`区域-第一月线下`,`大区-第二月线下`," \
